...
social_network.register_user("pablo", "Pablo Chorda")
social_network.register_user("manolo", "Manolo 87")

social_network.create_post("pablo", "Hola mundo!")
social_network.create_post("pablo", "Hola mundo 2!")
social_network.create_post("pablo", "Hola mundo 3!")
...
social_network.follow_user("manolo", "pablo")

social_network.like_post("manolo", 1)

social_network.view_user_feed("pablo")
